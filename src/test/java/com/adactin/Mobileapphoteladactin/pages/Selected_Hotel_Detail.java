...
/**
 * Selected Hotel Detail class has this page web-elements and methods
 * @author shwetabinu
 *
 */
public class Selected_Hotel_Detail extends BaseClass {
	...
	public Selected_Hotel_Detail() throws Exception {
		// super();
		//Initializing the elements of Selected Hotel Detail class
	 ...
	 * @return boolean result of the method
	 * @param rno Row number of test data
	 */
	...
	/**
	 * Method to read the expected data for Selected Hotel Detail page
