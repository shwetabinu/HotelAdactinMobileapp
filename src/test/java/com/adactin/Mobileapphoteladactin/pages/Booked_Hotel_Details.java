...
/**
 * Booked hotel details page web elements and methods
 * @author shwetabinu
 *
 */
public class Booked_Hotel_Details extends BaseClass {
	...
	public boolean cancelBooked_itinerary() {
		...
		try {
			...
			cancel_btn.click();
			//Explicitly waiting until alert ok is visible
	 ...
	 * @throws Exception Exception during validation
	 */
	public boolean checkBookedHotelDetails(int i) throws Exception {
		...
		try {
			...
			ScrollUtil.pageScroll(scrollpage);
	...
	/**
	 * Method to go back from the booked hotel details page
	 * @return boolean
	 */
