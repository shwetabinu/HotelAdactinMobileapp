...
/**
 * Book Hotel page web elements and methods
 * @author shwetabinu
 *
 */
public class Book_Hotel extends BaseClass {
	...
	public Book_Hotel() throws Exception {
		//Initializing the objects of the book hotel page
		PageFactory.initElements(driver, this);
		//Initializing Screenshot Capture object
	 ...
	 * @param rno Row number from test data file
	 *
	 */
	 ...
	 * 
	 * @param i row number
	 * @return boolean result of entering booking details
	 */
	public boolean enterBookingDetails(int i)
	{
		boolean result=true;
		try {
	 ...
	 * @return boolean result of verification of alert popup
	 ...
	 * @return boolean result of clicking Book Now button
	 */
	 ...
	 * @param rno Row number in the test case file
	 ...
	 * @return boolean : result of goBack method
	 */
