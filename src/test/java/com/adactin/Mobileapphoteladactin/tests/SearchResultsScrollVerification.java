...
/**
 * Test case to verify scrolling in the search hotel results page
 * @author shwetabinu
 *
 */
public class SearchResultsScrollVerification extends BaseClass {

	public SearchResultsScrollVerification() throws Exception {
		super();
	...
	/**
	 * Test case to validate search hotel result page scroll
	 * @throws Exception Exception during test execution
	 */
	@Test(groups = { "functionalTest" })
	public void User_is_able_to_scroll_up_down_the_search_results_of_the_search_hotel_screen() throws Exception
	{
		Log.startTestCase("User_is_able_to_scroll_up_down_the_search_results_of_the_search_hotel_screen");
		int rno;
		
		//Reading test data from the TestData file
		ExcelUtil.setExcelFileSheet("Testcases");
		rno=ExcelUtil.readExcel('r',"User_is_able_to_scroll_up_down_the_search_results_of_the_search_hotel_screen");
		...
		//Selecting the hotel
		sp=new Select_Hotel();
		boolean hotel_result=ScrollUtil.pageScrollToText("Select Hotel");
		...
		Log.endTestCase("User_is_able_to_scroll_up_down_the_search_results_of_the_search_hotel_screen");	
